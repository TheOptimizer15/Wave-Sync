...
type ActionSource = "PAYMENT_LINK" | string;

type FormatType = "DateTime" | null;

type BaseReceiptFieldLabel =
    | "Net Amount"
    | "Wave Fee Amount"
    | "Status"
    | "Date & time"
...
interface MerchantSweepSentEntry {
...
type HistoryEntry = MerchantSaleEntry | MerchantSweepSentEntry;
